...
export default function AssignmentDetail({
  ...
  return (
    <div
      className={`mx-auto flex flex-col gap-8 rounded-3xl border border-white/20 bg-white/40 p-8 shadow-xl backdrop-blur-xl ${
        isPageView
          ? "w-full max-w-none"
          : "max-h-[85vh] max-w-5xl overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent"
      }`}
    >
